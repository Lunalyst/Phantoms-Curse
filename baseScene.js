...
class baseScene extends Phaser.Scene {
  ...
  constructor(levelKey,isActive){
    // scene settings
    super({key: levelKey,active: isActive ,physics:{default:'arcade'}});
    ...
    //time out function to spawn enemys. if they are not delayed then the physics is not properly set up on them.
      setTimeout(function(){
        //generates enemys
        scene.activateFunctions.initSlimes(300, 500, 1,scene,scene.playerSex);
        scene.activateFunctions.initSlimes(300, 500, 1,scene,scene.playerSex);
        scene.activateFunctions.initSlimes(2380, 500, 1,scene,scene.playerSex);
        //scene.activateFunctions.initSlimes(500, 550, 1,scene,scene.playerSex);
        
        
        scene.spawnedEnemys = true;
      },1000);
      ...
      this.signCoolDown = false;
      setTimeout(function(){
        scene.loadCoolDown = true;
      },1000);
      setTimeout(function(){
        scene.saveCoolDown = true;
      },1000);
      setTimeout(function(){
        scene.signCoolDown = true;
      },1000);
    ...
    if(this.isPaused === false){
      if(this.grabbed === false){ 
        ...
        //this.activateFunctions.checkWarpPrompts(scene);
        //this.activateFunctions.checkSavePrompts(scene);
        //applies a function to every slime object by calling the blueSlimeCollisions function.
        this.activateFunctions.checkBlueSlimeInteractions(scene);
        ...
        this.activateFunctions.checkBlueSlimeGrab(scene);
      }
