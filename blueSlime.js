    ...
    slimeGrab(player1,hpBar,keyA,KeyDisplay,keyD,scene,keyTAB){
        ...
        //if the player is grabbed then do the following.
            ...
            if(this.playerDamaged === false && hpBar.playerHealth > 0 ){
             ...
             //console.log('Phaser.Input.Keyboard.JustDown(keyA)'+Phaser.Input.Keyboard.JustDown(keyA)+'strugglecounter: '+this.struggleCounter+" hpBar.playerHealth: "+hpBar.playerHealth+" this.slimeSize: "+this.slimeSize);
