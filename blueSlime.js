...
class blueSlime extends Phaser.Physics.Arcade.Sprite{
    constructor(scene, xPos, yPos,sex){
        ...
        if(sex === 0){
            ...
            this.anims.create({key: 'largeSlimeGrabDefeated3',frames: this.anims.generateFrameNames('CommonBlueSlime-evan', { start: 112, end: 115 }),frameRate: 7,repeat: -1});
            ...
            this.anims.create({key: 'largeSlimeGrabDefeated5',frames: this.anims.generateFrameNames('CommonBlueSlime-evan', { start: 120, end: 130 }),frameRate: 5,repeat: 0});
            this.anims.create({key: 'largeSlimeGrabDefeated6',frames: this.anims.generateFrameNames('CommonBlueSlime-evan', { start: 131, end: 134 }),frameRate: 7,repeat: -1});
            this.anims.create({key: 'largeSlimeGrabDefeated7',frames: this.anims.generateFrameNames('CommonBlueSlime-evan', { start: 135, end: 138 }),frameRate: 7,repeat: -1});
            this.anims.create({key: 'slimeGameOver1',frames: this.anims.generateFrameNames('CommonBlueSlime-evan', { start: 139, end: 142 }),frameRate: 7,repeat: -0});
            this.anims.create({key: 'slimeGameOver2',frames: this.anims.generateFrameNames('CommonBlueSlime-evan', { start: 142, end: 145 }),frameRate: 7,repeat: -1});
        }else{
            ...
            this.anims.create({key: 'slimeGrab',frames: this.anims.generateFrameNames('CommonBlueSlime-evelyn', { start: 14, end: 18 }),frameRate: 7,repeat: -1});
            this.anims.create({key: 'slimeGrabBreak',frames: this.anims.generateFrameNames('CommonBlueSlime-evelyn', { start: 18, end: 20 }),frameRate: 3,repeat: 0});
            this.anims.create({key: 'slimeGrabFallingDefeated',frames: this.anims.generateFrameNames('CommonBlueSlime-evelyn', { start: 21, end: 29 }),frameRate: 7,repeat: 0});
            ...
            this.anims.create({key: 'slimeGrabDefeated4',frames: this.anims.generateFrameNames('CommonBlueSlime-evelyn', { start: 40, end: 43 }),frameRate: 7,repeat: 0});
            this.anims.create({key: 'slimeGrabDefeated5',frames: this.anims.generateFrameNames('CommonBlueSlime-evelyn', { start: 45, end: 49 }),frameRate: 7,repeat: 0});
            this.anims.create({key: 'slimeGrabDefeated6',frames: this.anims.generateFrameNames('CommonBlueSlime-evelyn', { start: 50, end: 53 }),frameRate: 7,repeat: -1});
            this.anims.create({key: 'slimeGrabDefeated7',frames: this.anims.generateFrameNames('CommonBlueSlime-evelyn', { start: 53, end: 63 }),frameRate: 7,repeat: 0});
            this.anims.create({key: 'slimeGameOver',frames: this.anims.generateFrameNames('CommonBlueSlime-evelyn', { start: 64, end: 68 }),frameRate: 7,repeat: -1});
        }
    ...
    slimeGrab(player1,hpBar,keyA,KeyDisplay,keyD,scene,keyTAB){
        ...
        //if the player is grabbed then do the following.
            ...
            if(this.playerDamaged === false && hpBar.playerHealth > 0 ){
             ...
             if(this.struggleCounter > 0 && this.struggleCounter < 100){// this case subtracts from the struggle free counter if the value is not pressed fast enough.
                this.struggleCounter--;
                //console.log('strugglecounter: '+this.struggleCounter);
             }
             // large slime functions for breaking free as well
             if(this.slimeSize === 2 && hpBar.playerHealth >= 1 && this.largeSlimeDamageCounter === false){
            ...
            // if the player breaks free then do the following
             if(this.struggleCounter >= 100 && hpBar.playerHealth >= 1){
                ...
                if(this.slimeSize === 1 && this.struggleFree < 100 ){
                    ...
                    // fix this animation. dont use counter, use settimeout.
                }else if(this.slimeSize === 2 && this.struggleFree < 120 && hpBar.playerHealth >= 1 ){
                    console.log("Free counter: "+this.struggleFree);
                    this.struggleFree++;
    
                }else if(this.struggleFree >= 100 && hpBar.playerHealth >= 1){
                    this.struggleFree = 0;
                    this.playerBrokeFree = 0;
                    if(this.slimeSize === 1){
                        this.anims.play("slimeIdle",true);
    ...
    largeSlimeDefeatedPlayerAnimation(){
        ...
        if(this.playerDefeatedAnimationStage === 1){
            ...
            this.anims.play('largeSlimeGrabDefeated7',true);
        }
