...
class forestHomeLevel extends Phaser.Scene {
  ...
  constructor(){
    ...
    preload(){
      ...
      this.load.spritesheet('CommonBlueSlime-evan', 'assets/CommonBlueSlime-evan.png',{frameWidth: 300, frameHeight: 300 });
      this.load.spritesheet('CommonBlueSlime-evelyn', 'assets/CommonBlueSlime-evelyn.png',{frameWidth: 300, frameHeight: 300 });
    ...
    this.skipIndicator = this.add.sprite(450, 520,'TABToSkip');
    this.skipIndicator.setScale(.3);
