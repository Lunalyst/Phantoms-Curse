...
class forestHomeLevel extends Phaser.Scene {
  ...
  constructor(){
    ...
    //time out function to spawn enemys. if they are not delayed then the physics is not properly set up on them.
      setTimeout(function(){
        //generates enemys
        forestHomeThat.activateFunctions.initSlimes(680, 500, 1,forestHomeThat,forestHomeThat.playerSex);
        forestHomeThat.activateFunctions.initSlimes(680, 500, 1,forestHomeThat,forestHomeThat.playerSex);
        forestHomeThat.activateFunctions.initSlimes(2000, 500, 1,forestHomeThat,forestHomeThat.playerSex);
