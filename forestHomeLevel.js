...
class forestHomeLevel extends Phaser.Scene {
  ...
  constructor(){
    ...
    preload(){
      ...
      //loads sprites.
      this.load.spritesheet("malePlayer" , "assets/evan_master.png" , {frameWidth: 71 , frameHeight: 90 });
      this.load.spritesheet("femalePlayer" , "assets/evelyn_master.png" , {frameWidth: 71 , frameHeight: 90 });
      ...
      this.load.spritesheet('CommonBlueSlime-evan', 'assets/CommonBlueSlime-evan.png',{frameWidth: 100, frameHeight: 100 });
      this.load.spritesheet('CommonBlueSlime-evelyn', 'assets/CommonBlueSlime-evelyn.png',{frameWidth: 100, frameHeight: 100 });
    ...
    this.healthDisplay = new hpBar(this,250,170,'healthBar');
    //loads local save data.
    this.activateFunctions.loadGame(this);
  
    //controls the Background
    this.backround = this.add.tileSprite(0, 100, 10000, 3000, "backgroundForest");
    //this.backround.setScale(2,2);
      //creates a player inventory object
      this.playerInventory = new inventory(this,420,500,"inventory");
    ...
    //time out function to spawn enemys. if they are not delayed then the physics is not properly set up on them.
      setTimeout(function(){
        //generates enemys
        forestHomeThat.activateFunctions.initSlimes(600, 550, 1,forestHomeThat,forestHomeThat.playerSex);
