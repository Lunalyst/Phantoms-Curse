...
//fixing line issues with tiles
//https://github.com/sporadic-labs/tile-extruder

//C:\Users\xmani\tiledMap
//tile-extruder --tileWidth 32 --tileHeight 32  -s0 --input ./tiledMap/TileSetV.0.8.png --output ./tiledMap/TileSetV.0.8.png
...
class forestHomeLevel extends Phaser.Scene {
  ...
  constructor(){
    ...
    this.activateFunctions.initPortals(2813,517,this,420,900,0);
    this.activateFunctions.initPortals(396,580,this,4373,612,0);
    ...
    update(){
      //this.backround.y = this.player1.y-500;
      //console.log("warpToX:"+ this.warpToX +" warpToY: "+this.warpToY );
