    ...
    gameoverThat = this;
        ...
        create(){
           ...
           console.log("this.playersex: "+ this.playerSex);
            ...
            this.tryAgian = this.add.sprite(450, 360, "tryAgianSign").setInteractive();
            ...
            if(this.enemyThatDefeatedPlayer === "blueSlime"){
                this.enemy = new blueSlime(this,450, 295,this.playerSex);
            ...
            this.tryAgian.on('pointerdown', function (pointer) {
              ...
              if(that.playerSex){
                console.log("this.playersex: "+ that.playerSex);
                console.log("sending player to game scene after game over without a save file");
