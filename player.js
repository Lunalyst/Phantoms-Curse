...
class player extends Phaser.Physics.Arcade.Sprite{
  ...
  constructor(scene, xPos, yPos){
    ...
    this.anims.create({key: 'pRight',frames: this.anims.generateFrameNames('malePlayer', { start: 9, end: 12 }),frameRate: 14,repeat: -1});
    ...
    this.anims.create({key: 'pLeft',frames: this.anims.generateFrameNames('malePlayer', { start: 16, end: 20 }),frameRate: 14 ,repeat: -1});
