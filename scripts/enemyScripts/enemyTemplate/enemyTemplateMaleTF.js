...
class enemyTemplateMaleTF extends enemy {
    ...
    playerIsStrugglingLogicMaleTFASM(){
        ...
        if(this.startedGrab === false && this.animationPlayed === false){
            ...
            this.anims.play('enemyTemplateGrabbed').once('animationcomplete', () => {
                ...
                //this.anims.play('enemyTemplateStruggle', true);
    ...
    playerEscapedMaleTF(playerHealthObject){
         ...
         let currentenemyTemplate = this;
            ...
            if (this.struggleFree === false) {
                ...
                currentenemyTemplate.struggleFree = true;
                ...
                setTimeout(function () {
                    ...
                    currentenemyTemplate.grabCoolDown = false;
    ...
    playerIsDefeatedLogicMaleTF(){
           ...
           // these cases check if the player should be damages over time if grabbed. if so then damage the player based on the size of the enemyTemplate.
        ...
        if (this.playerDefeatedAnimationStage === 0) {
            ...
            let currentenemyTemplate = this; // important, sets currentenemyTemplate to the current object so that we can use variables attached to this current enemyTemplate object in our set timeout functions.
            //console.log("this.playerDefeatedAnimationStage: "+this.playerDefeatedAnimationStage);
            // delay the button prompt so the animation can play.
            setTimeout(function () {
                currentenemyTemplate.scene.KeyDisplay.visible = true;
                currentenemyTemplate.scene.KeyDisplay.playDKey();
                //incriment the animation prompt since we want to move on to the next animation after the current one finishes
                console.log("currentenemyTemplate.playerDefeatedAnimationStage: " + currentenemyTemplate.playerDefeatedAnimationStage);
            }, 1000);
            ...
            if (this.scene.checkDIsDown() &&
                ...
                this.currentenemyTemplate = this;// massively important. allows for the settimeout functions to acess variables attached to this object.
                setTimeout(function () {
                    console.log("defeated animation delay.");
                    currentenemyTemplate.scene.KeyDisplay.visible = true;
                    currentenemyTemplate.scene.KeyDisplay.playDKey();
                    currentenemyTemplate.playerDefeatedAnimationCooldown = false;
                }, 3000);
            }
            ...
            if (this.scene.checkSkipIndicatorIsDown() || (this.isMaxStageMaleTF() && this.scene.checkDIsDown())) {
                ...
                if(this.enemySex === 0){
                    this.scene.enemyThatDefeatedPlayer = bestiaryKey.enemyTemplateTF;
                }else{
                    this.scene.enemyThatDefeatedPlayer = bestiaryKey.enemyTemplateFemaleTF;
                }
    ...
    enemyDefeatedPlayerAnimationMaleTF(){
        ...
        if (this.playerDefeatedAnimationStage === 1) {
            ...
            if (!this.animationPlayed) {
                ...
                this.animationPlayed = true;
                this.anims.play('enemyTemplateTailSwallow1').once('animationcomplete', () => {
            ...
            this.anims.play('enemyTemplateTailStruggle', true);

            this.playPlapSound('plap3',800);

            let thisenemyTemplate = this;
            if (this.onomatPlayed === false) {
                ...
                setTimeout(function () {
                    thisenemyTemplate.onomatPlayed = false;
                }, 600);
            }
            ...
            if (!this.animationPlayed) {
                ...
                this.animationPlayed = true;
                this.anims.play('enemyTemplateTailSwallow2').once('animationcomplete', () => {
                    //this.scene.onomat.destroy();
                    this.animationPlayed = false;
                    this.playerDefeatedAnimationStage++;
                    this.inStartDefeatedLogic = false;
            ...
            if (!this.animationPlayed) {
                ...
                this.animationPlayed = true;
                this.anims.play('enemyTemplateTailSwallow3').once('animationcomplete', () => {
                    //this.scene.onomat.destroy();
                    this.animationPlayed = false;
                    this.playerDefeatedAnimationStage++;
                    this.inStartDefeatedLogic = false;
            ...
            this.anims.play('enemyTemplateTailJiggle', true);
           
        }
    }

    // functioned called to play animation when the player is defeated by the enemyTemplate in gameover.
    gameOver(playerSex) {
        this.setSize(70, 180, true);
        //this.setOffset(180, 110);
        this.anims.play('enemyTemplateGameover').once('animationcomplete', () => {

            this.anims.play('enemyTemplateMove', true);
