...
class jackOVineMaleTF extends enemy {
    ...
    playerEscapedMaleTF(playerHealthObject){
         ...
         let currentjackOVine = this;
            ...
            if (this.struggleFree === false) {
                ...
                currentjackOVine.struggleFree = true;
    ...
    playerIsDefeatedLogicMaleTF(){
        ...
        if (this.playerDefeatedAnimationStage === 0) {
            ...
            let currentjackOVine = this; // important, sets currentjackOVine to the current object so that we can use variables attached to this current jackOVine object in our set timeout functions.
            //console.log("this.playerDefeatedAnimationStage: "+this.playerDefeatedAnimationStage);
            // delay the button prompt so the animation can play.
            setTimeout(function () {
                currentjackOVine.scene.KeyDisplay.visible = true;
                currentjackOVine.scene.KeyDisplay.playDKey();
                //incriment the animation prompt since we want to move on to the next animation after the current one finishes
                console.log("currentjackOVine.playerDefeatedAnimationStage: " + currentjackOVine.playerDefeatedAnimationStage);
            }, 1000);
            ...
            if (this.scene.checkDIsDown() &&
                ...
                this.currentjackOVine = this;// massively important. allows for the settimeout functions to acess variables attached to this object.
                setTimeout(function () {
                    console.log("defeated animation delay.");
                    currentjackOVine.scene.KeyDisplay.visible = true;
                    currentjackOVine.scene.KeyDisplay.playDKey();
                    currentjackOVine.playerDefeatedAnimationCooldown = false;
                }, 3000);
            }
