...
class genericDefeat extends enemy {
    
    constructor(scene, xPos, yPos, sex, id,inSafeMode) {
        //super() calls the constructor() from the parent class we are extending
        super(scene, xPos, yPos, sex, id, 20, 'genericDefeat');
        ...
        if (sex === 0) {
            this.anims.create({ key: 'playerFall', frames: this.anims.generateFrameNames('malePlayerStucks', { start: 19, end: 24 }), frameRate: 7, repeat: 0});
            this.anims.create({ key: 'playerDefeated', frames: this.anims.generateFrameNames('malePlayerStucks', { start: 25, end: 25 }), frameRate: 7, repeat: -1 });

        }else{
            this.anims.create({ key: 'playerFall', frames: this.anims.generateFrameNames('femalePlayerStucks', { start: 19, end: 24 }), frameRate: 7, repeat: 0});
            this.anims.create({ key: 'playerDefeated', frames: this.anims.generateFrameNames('femalePlayerStucks', { start: 25, end: 25 }), frameRate: 7, repeat: -1 });
    ...
    playerIsDefeatedLogic(){
        ...
        // these cases check if the player should be damages over time if grabbed. if so then damage the player based on the size of the enemy.
            ...
            this.scene.enemyThatDefeatedPlayer = null;
        ...
        let currentEnemy = this;
         if (this.playerDefeatedAnimationStage === 1) {
            ...
            if (!this.animationPlayed) {
                    ...
                    this.anims.play('playerFall').once('animationcomplete', () => {
            ...
            this.anims.play("playerADefeat",true);
        }
    }
