...
class itemDrop extends Phaser.Physics.Arcade.Sprite{
    ...
    constructor(scene, xPos, yPos,setItemID,setItemStackable,setItemAmount,itemName,itemDescription,type,sell){
        ...
        this.anims.create({key: '-1',frames: this.anims.generateFrameNames('shellIcon', { start: 0, end: 0 }),frameRate: 10,repeat: -1});
        ...
        this.anims.create({key: '22',frames: this.anims.generateFrameNames('itemDrops', { start: 22, end: 22 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '23',frames: this.anims.generateFrameNames('itemDrops', { start: 23, end: 23 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '24',frames: this.anims.generateFrameNames('itemDrops', { start: 24, end: 24 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '25',frames: this.anims.generateFrameNames('itemDrops', { start: 25, end: 25 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '26',frames: this.anims.generateFrameNames('itemDrops', { start: 26, end: 26 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '27',frames: this.anims.generateFrameNames('itemDrops', { start: 27, end: 27 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '28',frames: this.anims.generateFrameNames('itemDrops', { start: 28, end: 28 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '29',frames: this.anims.generateFrameNames('itemDrops', { start: 29, end: 29 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '30',frames: this.anims.generateFrameNames('itemDrops', { start: 30, end: 30 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '31',frames: this.anims.generateFrameNames('itemDrops', { start: 31, end: 31 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '32',frames: this.anims.generateFrameNames('itemDrops', { start: 32, end: 32 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '33',frames: this.anims.generateFrameNames('itemDrops', { start: 33, end: 33 }),frameRate: 10,repeat: -1});
        this.anims.create({key: '34',frames: this.anims.generateFrameNames('itemDrops', { start: 34, end: 34 }),frameRate: 10,repeat: -1});
