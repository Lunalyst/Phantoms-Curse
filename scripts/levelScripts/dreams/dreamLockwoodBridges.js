...
class dreamLockwoodBridges extends defaultScene {
  
  constructor(){
    // scene settings
    super({key: 'dreamLockwoodBridges',active: false ,physics:{default:'arcade'}});
    //variables attached to the scene

    //this varialve stores the key so that when the player saves they load back in the correct location
    this.playerLocation = "dreamLockwoodBridges";
    ...
    create(){
      ...
      this.initPortals(3566,728-8,782,728,"warpCaveInside","dreamLockwoodEntrance",false);
      ...
      let thisScene = this;
        ...
        this.backround = this.add.tileSprite(2000, 300, 1400*4, 664*2, "dreamBackground");
