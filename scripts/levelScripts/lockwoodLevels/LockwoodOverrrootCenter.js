...
class LockwoodOverrootCenter extends defaultScene {
  
  constructor(){
    // scene settings
    super({key: 'LockwoodOverrootCenter',active: false ,physics:{default:'arcade'}});
    //variables attached to the scene

    //this varialve stores the key so that when the player saves they load back in the correct location
    this.playerLocation = "LockwoodOverrootCenter";
    ...
    preload(){
      ...
      this.load.tilemapTiledJSON("lockwood_overroot_center_map" , "assets/tiledMap/LockWood/Lockwood_Shop_District_Tileset/Lockwood_Overroot_Center.json");
    ...
    create(){
      ...
      //creates tileset
      this.setUpTileSet("lockwood_overroot_center_map","Lockwood_Shop_District_Tileset","lockwood_shop_district_source_map");
      ...
      */
      ...
      this.initPortals(1776,728-8,1818,728,"warpCaveInside","LockwoodShopDistrict",false);
      ...
      let thisScene = this;
        ...
        this.olivia = this.add.sprite(1481, 728-1, "olivia");
    ...
    update(){
      ...
      this.checkPlayerRightWarp(2450,"LockwoodOverrootAlley",1845,728);
