...
class batCave extends defaultScene {
  ...
  constructor(){
    ...
    create(){
      ...
      //activates sound
      this.initLoopingSound('caveSFX','cave', 0.05,"music");
      ...
      this.initPortals(4001,541-13,5601-4160,893,"warpCaveOutside","sunFlowerCave");
      ...
      let thisScene = this;
      setTimeout(function(){
        thisScene.initEnemy(2620,962,thisScene.playerSex,'bat',false);

        thisScene.initEnemy(3333,962,thisScene.playerSex,'bat',false);

        thisScene.initEnemy(1137,546,thisScene.playerSex,'bat',false);
