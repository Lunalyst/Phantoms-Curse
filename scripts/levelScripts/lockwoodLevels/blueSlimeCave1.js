...
class blueSlimeCave1 extends defaultScene {
  ...
  constructor(){
    ...
    create(){
      ...
      this.initPortals(1250,1565-13,885,1469-416,"warpCaveInside","sunFlowerField");
      //this.fakeWarp3 = new fakeWarp(this,1796,573-13,'warpCaveOutsideRubble');
      ...
      setTimeout(function(){
          ...
          thisScene.initEnemy(891, 568,thisScene.playerSex,'blueSlimeLarge',false);
          ...
          //thisScene.initEnemy(899, 568,thisScene.playerSex,'blueSlimeHM',false);
