...
class hiveChamber1 extends defaultScene {
  
  constructor(){
    // scene settings
    super({key: 'hiveChamber1',active: false ,physics:{default:'arcade'}});
    //variables attached to the scene

    //this varialve stores the key so that when the player saves they load back in the correct location
    this.playerLocation = "hiveChamber1";
    ...
    create(){
      ...
      //creates tileset
      this.setUpTileSet("Hive_Grub_Chamber1_map","Hive_Tileset","hive_source_map");
      ...
      this.savePointCover.setScale(1/3);
      this.savePointCover.setDepth(3);
      this.savePointCover.setPipeline('Light2D');
      //sets up containers
      ...
      let thisScene = this;
      setTimeout(function(){
        thisScene.initEnemy(1011, 1016+4,thisScene.playerSex,'beeGrub',false,);
