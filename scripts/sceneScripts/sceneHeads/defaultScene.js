class defaultScene extends G12UpdateLoops {
    ...
    defaultPreload(){
      ...
      this.load.spritesheet('playerProjectiles', 'assets/player/playerProjectiles.png',{frameWidth: 219, frameHeight: 219 });
      ...
      this.load.audioSprite('fastTravelWingFlapSFX','audio/used-audio/wing-flap-sounds/wing-flap-sounds.json',[
       ...
       this.load.spritesheet("autumnMaleExtension" , "assets/npcs/autumnMaleExtension.png" , {frameWidth: 483 , frameHeight: 459 });
