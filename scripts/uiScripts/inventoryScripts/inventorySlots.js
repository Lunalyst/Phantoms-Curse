class inventorySlots extends Phaser.Physics.Arcade.Sprite{
    ...
    constructor(scene, xPos, yPos){
      ...
      this.anims.create({key: '26',frames: this.anims.generateFrameNames('inventorySlots', { start: 26, end: 26 }),frameRate: 10,repeat: -1});
      this.anims.create({key: '27',frames: this.anims.generateFrameNames('inventorySlots', { start: 27, end: 27 }),frameRate: 10,repeat: -1});
      ...
      this.anims.create({key: '37',frames: this.anims.generateFrameNames('inventorySlots', { start: 37, end: 37  }),frameRate: 10,repeat: -1});
      this.anims.create({key: '38',frames: this.anims.generateFrameNames('inventorySlots', { start: 38, end: 38  }),frameRate: 10,repeat: -1});
