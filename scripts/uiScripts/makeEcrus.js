class makeEcrus extends Phaser.GameObjects.Container{

    constructor(scene, xPos, yPos,text,offset){
        ...
        for (let counter = 0; counter < this.letterString.length; counter++) {
          ...
          if(this.letterString.charAt(counter) !== '@' && specialCharacter === false){
            this.letters.push(new ercus(scene, this.x + startingX, this.y + startingY,specialCharText));
