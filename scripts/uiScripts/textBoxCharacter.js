class textBoxCharacter extends Phaser.Physics.Arcade.Sprite{
    ...
    constructor(scene, xPos, yPos,font){
      ...
      this.anims.create({key: '*',frames: this.anims.generateFrameNames(font, { start: 36, end:36 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '+',frames: this.anims.generateFrameNames(font, { start: 37, end: 37 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '-',frames: this.anims.generateFrameNames(font, { start: 38, end: 38 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '=',frames: this.anims.generateFrameNames(font, { start: 39, end: 39 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '$',frames: this.anims.generateFrameNames(font, { start: 40, end: 40 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '%',frames: this.anims.generateFrameNames(font, { start: 41, end: 41 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '/',frames: this.anims.generateFrameNames(font, { start: 42, end: 42 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '\'',frames: this.anims.generateFrameNames(font, { start: 43, end: 43 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '#',frames: this.anims.generateFrameNames(font, { start: 44, end: 44 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '.',frames: this.anims.generateFrameNames(font, { start: 45, end: 45 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: ',',frames: this.anims.generateFrameNames(font, { start: 46, end: 46 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: ':',frames: this.anims.generateFrameNames(font, { start: 47, end: 47 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: ';',frames: this.anims.generateFrameNames(font, { start: 48, end: 48 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '?',frames: this.anims.generateFrameNames(font, { start: 49, end: 49 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '!',frames: this.anims.generateFrameNames(font, { start: 50, end: 50 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: "`",frames: this.anims.generateFrameNames(font, { start: 51, end: 51 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '"',frames: this.anims.generateFrameNames(font, { start: 52, end: 52 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '^',frames: this.anims.generateFrameNames(font, { start: 53, end: 53 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '&',frames: this.anims.generateFrameNames(font, { start: 54, end: 54 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '(',frames: this.anims.generateFrameNames(font, { start: 55, end: 55 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: ')',frames: this.anims.generateFrameNames(font, { start: 56, end: 56 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '[',frames: this.anims.generateFrameNames(font, { start: 57, end: 57 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: ']',frames: this.anims.generateFrameNames(font, { start: 58, end: 58 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '{',frames: this.anims.generateFrameNames(font, { start: 59, end: 59 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '}',frames: this.anims.generateFrameNames(font, { start: 60, end: 60 }),frameRate: this.frames,repeat: this.repeats});
      this.anims.create({key: '<"',frames: this.anims.generateFrameNames(font, { start: 61, end: 61 }),frameRate: this.frames,repeat: this.repeats});
      ...
      this.anims.create({key: '_',frames: this.anims.generateFrameNames(font, { start: 63, end: 63 }),frameRate: this.frames,repeat: this.repeats});
