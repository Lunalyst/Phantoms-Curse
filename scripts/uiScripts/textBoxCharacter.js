class textBoxCharacter extends Phaser.Physics.Arcade.Sprite{
    ...
    constructor(scene, xPos, yPos){
      ...
      this.anims.create({key: '?',frames: this.anims.generateFrameNames('characterSet', { start: 49, end: 49 }),frameRate: 1,repeat: -1});
      ...
      this.anims.create({key: '_',frames: this.anims.generateFrameNames('characterSet', { start: 63, end: 63 }),frameRate: 1,repeat: -1});
