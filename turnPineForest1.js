...
class turnPineForest1 extends Phaser.Scene {
  ...
  constructor(){
    ...
    preload(){
      ...
      this.load.spritesheet('backgroundForest1', 'assets/forestBackround1.png',{frameWidth: 1047, frameHeight: 699 });
      //loads sprites.
   ...
   //controls the Background
    this.backround = this.add.tileSprite(0, 480, 10000, 3000, "backgroundForest1");
    this.backround.setScale(1.9,1.9);
