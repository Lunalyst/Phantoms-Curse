...
class turnPineForest1 extends Phaser.Scene {
  ...
  constructor(){
   ...
   //controls the Background
    ...
    this.processMap.tilesetNameInTiled = "Tile Set V.0.7";
    ...
    this.activateFunctions.initPortals(97,420,this,2813,517);
    this.activateFunctions.initPortals(3000,390,this,396,580);
