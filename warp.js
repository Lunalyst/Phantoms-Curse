...
// lesson learned dont but scene triggers in a overlap function.
    warpTo(scene1,keyW,location,activeId){
        ...
        if(scene1.safeToLoad === true && keyW.isDown && activeId === this.warpPortalId){
            console.log("saving game location");
            console.log("this.nextSceneX "+ this.nextSceneX +" this.nextSceneY: "+this.nextSceneY );
            scene1.activateFunctions.saveGame(this.nextSceneX,this.nextSceneY);
            scene1.portalId = 0;
           ...
           /* scene1.physics.add.overlap(scene1.player1,this,function(){
                ...
                activeId = this.warpPortalId;
                //console.log("overlaping with warp zone");
            });*/
            console.log("is it safe to warp player:" + scene1.safeToLoad+" activeId: "+activeId);
          }  
    }
